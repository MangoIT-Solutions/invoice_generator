...
import { sql } from '@/lib/mysql'; // Adjust import if your MySQL helper is elsewhere

// GET /api/projects/validate-code?code=PRJ-123
export async function GET(request: Request) {
  try {
    ...
    const allRows = await sql(
      'SELECT project_code FROM projects_details'
    );
